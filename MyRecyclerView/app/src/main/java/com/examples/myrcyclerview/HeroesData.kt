...
object HeroesData {
    private val heroNames = arrayOf("Ahmad Dahlan","Ahmad Yani", "Sutomo", "Gatot Soebroto",
        "Ki Hajar dewantara", "Mohammad Hatta", "Soedirman", "Soekarno",
        "Soepomo", "Tan Malaka")
    ...
    private val heroImages = intArrayOf(R.drawable.ahmad_dahlan, R.drawable.ahmad_yani, R.drawable.bung_tomo,
        R.drawable.gatot_subroto, R.drawable.ki_hadjar_dewantara, R.drawable.mohammad_hatta,
        R.drawable.sudirman, R.drawable.sukarno, R.drawable.supomo, R.drawable.tan_malaka)
